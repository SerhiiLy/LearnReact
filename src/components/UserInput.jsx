    ...
    return <section id="user-input">
        <div className="input-group">
            <p>
                ...
                <input type="number" name="" required value={userInput.initialInvestment}
                       onChange={(event) => onChangeInput('initialInvestment', event.target.value)}/>
            </p>
            <p>
                <label>Annual Investment</label>
                <input type="number" name="" required value={userInput.annualInvestment}
        ...
        <div className="input-group">
            <p>
                ...
                <input type="number" name="" required value={userInput.expectedReturn}
                       onChange={(event) => onChangeInput('expectedReturn', event.target.value)}/>
            </p>
            <p>
                <label>Duration Investment</label>
                <input type="number" name="" value={userInput.duration}
